...
<?php if ($this->_rootref['S_SETTINGS']) {  ?>
	...
	<dl>
		<dt><label for="max_num_search_keywords"><?php echo ((isset($this->_rootref['L_MAX_NUM_SEARCH_KEYWORDS'])) ? $this->_rootref['L_MAX_NUM_SEARCH_KEYWORDS'] : ((isset($user->lang['MAX_NUM_SEARCH_KEYWORDS'])) ? $user->lang['MAX_NUM_SEARCH_KEYWORDS'] : '{ MAX_NUM_SEARCH_KEYWORDS }')); ?>:</label><br /><span><?php echo ((isset($this->_rootref['L_MAX_NUM_SEARCH_KEYWORDS_EXPLAIN'])) ? $this->_rootref['L_MAX_NUM_SEARCH_KEYWORDS_EXPLAIN'] : ((isset($user->lang['MAX_NUM_SEARCH_KEYWORDS_EXPLAIN'])) ? $user->lang['MAX_NUM_SEARCH_KEYWORDS_EXPLAIN'] : '{ MAX_NUM_SEARCH_KEYWORDS_EXPLAIN }')); ?></span></dt>
		<dd><input id="max_num_search_keywords" type="text" size="4" maxlength="4" name="config[max_num_search_keywords]" value="<?php echo (isset($this->_rootref['MAX_NUM_SEARCH_KEYWORDS'])) ? $this->_rootref['MAX_NUM_SEARCH_KEYWORDS'] : ''; ?>" /></dd>
	</dl>
	<dl>
