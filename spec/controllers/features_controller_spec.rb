  ...
  shared_examples('admin access to features') do
    describe "GET new" do
      it "assigns a new feature as @feature" do
        get :new, id: feature, product_id: product.to_param
    ...
    describe "GET edit" do
      it "assigns the requested feature as @feature" do
        get :edit, id: feature, product_id: product.to_param
    ...
    describe "POST create" do
      describe "with valid params" do
        it "creates a new Feature" do
          expect {
            post :create, { feature: valid_attributes, product_id: product.to_param }
      ...
      describe "with invalid params" do
        it "assigns a newly created but unsaved feature as @feature" do
          post :create, { feature: invalid_attributes, product_id: product.to_param }
          expect(assigns(:feature)).to be_a_new(Feature)
        end
    ...
    describe "PATCH #update" do
      describe "with valid params" do
        it "assigns the requested feature as @feature" do
          patch :update, id: feature.to_param, feature: valid_attributes, product_id: product.to_param
          expect(assigns(:feature)).to eq(feature)
        end
  
        it "changes feature's attributes" do
          patch :update, id: feature, feature: { caption: 'New caption' }, product_id: product.to_param
          feature.reload
      ...
      describe "with invalid params" do
        it "does not change feature's attributes" do
          patch :update, id: feature, feature: { caption: nil }, product_id: product.to_param
          feature.reload
          expect(feature.caption).not_to eq('New caption')
        end

        it "re-renders the 'edit' template" do
          patch :update, id: feature.to_param, feature: invalid_attributes, product_id: product.to_param
    ...
    describe "DELETE destroy" do
      it "destroys the requested feature" do
        feature.save!
        expect {
          delete :destroy, id: feature, product_id: product.to_param
        }.to change(Feature, :count).by(-1)
      end
